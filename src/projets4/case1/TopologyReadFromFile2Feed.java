 ...
 * 
 */
public class TopologyReadFromFile2Feed {
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("SliderBolt", new FilterBolt(), 1).fieldsGrouping(
				"ReadFromFileSpout", new Fields("obj"));
		
		builder.setBolt("ArimaBolt", new ArimaBolt(), 2).fieldsGrouping(
